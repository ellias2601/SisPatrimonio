...
INSERT INTO EstadoBem (nomeEstadoBem) VALUES ('Ótimo');
INSERT INTO EstadoBem (nomeEstadoBem) VALUES ('Bom');
INSERT INTO EstadoBem (nomeEstadoBem) VALUES ('Regular');
INSERT INTO EstadoBem (nomeEstadoBem) VALUES ('Sucata');



INSERT INTO ContaContabil (descricaoContaContabil, codigoContaContabil) VALUES ('Móveis e Utensilios Domésticos', '23.3234.12.12');



INSERT INTO TipoAquisicao(descricaoTipoAquisicao) VALUES ('Comprado');
INSERT INTO TipoAquisicao(descricaoTipoAquisicao) VALUES ('Doado');


INSERT INTO TipoIncorporacao(descricaoTipoIncorporacao) VALUES ('Transferência Recebida');
INSERT INTO TipoIncorporacao(descricaoTipoIncorporacao) VALUES ('Doação de Instituições Públicas');
...
INSERT INTO Origem (descricaoOrigem, ruaOrigem, bairroOrigem, numeroOrigem, cepOrigem, telefoneOrigem, idSecretaria) VALUES ('Almoxarifado 01 Saúde', 'Rua 56', 'Vila América', 22,'75467-000','062 35143434', 1);

INSERT INTO Origem (descricaoOrigem, ruaOrigem, bairroOrigem, numeroOrigem, cepOrigem, telefoneOrigem, idSecretaria) VALUES ('Depósito Municipal da Educação', 'Rua 56', 'Vila América', 22,'75467-000','062 35143434', 2);
...
INSERT INTO SubDestino(nomeSubDestino,idDestino) VALUES ('Sala de Vacina', 1);

INSERT INTO SubDestino(nomeSubDestino,idDestino) VALUES ('Sala de Prevenção', 1);

INSERT INTO Bem (dataCadastroBem, descricaoBem, valorBem, numeroAtualBem, numeroAntigoBem, observaçõesBem, qtdACadastrarBem, idUsuario, idFundo, idTipoBem, idSubElemento, idClassificacao, idEstadoBem, idEmpresa, idResponsavel, idOrigem, idDestino, idSubDestino, idContaContabil, idTipoAquisicao, idTipoIncorporacao, idSecretaria) VALUES ('2019-12-12', 'Cadeira Fixa Almofadada', 5000.00, 023345, 012345, 'Recepção, Atrás do Balcão', '2', 1, 1, 1, 2, 1, 1, 1, 1, 1, 2, 2, 1, 1, 1, 1);
